...
NS_SWIFT_NAME(CurrencyCodeAUD)
extern NSString * const SMPCurrencyCodeAUD;
...
NS_SWIFT_NAME(CurrencyCodeCOP)
extern NSString * const SMPCurrencyCodeCOP;
...
NS_SWIFT_NAME(CurrencyCodeMXN)
extern NSString * const SMPCurrencyCodeMXN;
...
NS_SWIFT_NAME(CurrencyCodeHRK)
extern NSString * const SMPCurrencyCodeHRK;
